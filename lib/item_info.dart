...
class item_info extends StatefulWidget {
  ...
  item_info({required this.med}); // Message med2;

   State<item_info> createState() => item_info1();
}

class item_info1 extends State<item_info> {
  int counter = 1;
  int index = 0;
  bool state=true;
  getfav()async{
    ...
    request.fields.addAll({
      'product_id': widget.med.id.toString()
    });
  ...
  Widget build(BuildContext context) {
                ...
                Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                    "Scientific Name :   ${widget.med.composition}"
                    ,style: TextStyle(
    ...
    "Type :   ${widget.med.type}",
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          "Expiration date:   ${widget.med.expirationDate}"
                          ,style: TextStyle(
                            fontWeight: FontWeight.bold, fontSize: 20),
                        ),
                      ],
                    ...
                    Row(
                      ...
                      children: [
                        Text(
    "${widget.med.price.toStringAsFixed(1)}    SYP",
                          style: TextStyle(
                              fontWeight: FontWeight.bold, fontSize: 20),
                        ),
                      ],
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(
                                onPressed: () {
                                  setState(() {
                                    if(counter<widget.med.quantity)
                                      counter++;
                                  });
                                },
