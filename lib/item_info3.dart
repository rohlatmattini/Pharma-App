...
import 'login.dart';
import 'navo.dart';
class item_info4 extends StatefulWidget {

 Favorite mef;

 item_info4({required this.mef}); // item_info( {required Message med});


  // Product product;
  // item_info(this.product);
  State<item_info4> createState() => item_info5();
}

class item_info5 extends State<item_info4> {
  int counter = 1;
  int index = 0;
  bool state=true;
  ...
  getfav()async{
    ...
    request.fields.addAll({
      'product_id': widget.mef.id.toString()
    });
                    ...
                    Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              widget.mef.price.toStringAsFixed(1),
                              style: TextStyle(
                                  fontWeight: FontWeight.bold, fontSize: 20),
                            ),
                          ],
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  IconButton(
                                    onPressed: () {
                                      setState(() {
                                        if(counter<widget.mef.quantity)
                                          counter++;
                                      });
                                    },
